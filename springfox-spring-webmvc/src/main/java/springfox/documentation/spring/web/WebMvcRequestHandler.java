...
public class WebMvcRequestHandler implements RequestHandler {
    ...
    protected boolean isPathPatternParser() {
        return webMvcProperties.getPathmatch().getMatchingStrategy()
    ...
    public RequestHandlerKey key() {
        ...
        if (isPathPatternParser()) {
            PathPatternsRequestCondition patternsRequestCondition = requestMapping.getPathPatternsCondition();
            pathMappings = patternsRequestCondition == null ? Collections.emptySet() :
                    patternsRequestCondition.getDirectPaths();
        } else {
        ...
        return new RequestHandlerKey(pathMappings,
